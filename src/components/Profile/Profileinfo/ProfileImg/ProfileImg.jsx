...
const ProfileImg = (props) => {
 ...
 if(lookingJob.toLocaleUpperCase() === "YES"){
   isLooking = true
 }else if(lookingJob.toLocaleUpperCase() === "NO"){
   isLooking = false
 }
    ...
    <>
      <section className={s.infoProfile}>
        <div className={s.profileAvatar}>
          ...
          <div className={s.wrapperInput}>{editMode ? <EditModeInput placeholder={'Looking for a job'} value={lookingJob} setValue={setLookingJob}/> : <>Looking for job
            : {profile && profile.lookingForAJob ? <p>Yes</p> :
              <p>NO</p>}</>} </div>
